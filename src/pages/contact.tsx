    ...
    <StoreLayout>
      <div className="mx-auto my-6 max-w-4xl rounded-lg p-6 text-center sm:shadow-sm lg:border lg:border-gray-200">
        ...
        <p className="text-lg text-gray-600">
          We're here to help you with any questions or concerns you may have. Our customer service team is available to
          assist you with any inquiries about our products, shipping, returns, and more. Please don't hesitate to get in
          touch with us if you need assistance.
          <br />
          <br />
          Email us at:{' '}
          <b>
