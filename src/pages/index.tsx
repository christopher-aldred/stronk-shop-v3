    ...
    <StoreLayout>
      ...
      <div className="flex flex-col justify-center">
        <div className="relative top-0 py-0 sm:-top-10 sm:mx-auto sm:max-w-2xl sm:py-3">
          ...
          <div className="relative z-20 rounded-3xl bg-white p-20 p-4 sm:bg-slate-50 sm:py-10 sm:shadow-lg">
            <h1 className="mb-2 text-2xl font-bold text-gray-700">About Us</h1>
