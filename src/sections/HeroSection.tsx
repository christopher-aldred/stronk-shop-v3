  ...
  return (
    <>
      <div className="bg-container bg-[url('/images/bg.jpeg')] bg-cover bg-no-repeat text-white">
        <div className="bg-black/30 shadow-[inset_0_0px_24px_rgba(0,0,0,0.2)]">
          <section className="mx-auto max-w-2xl py-10 md:py-24">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <NextLink
                href="/products"
                className="z-10 rounded-md bg-[#0080fe] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#1466b7] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Browse Products
              </NextLink>
